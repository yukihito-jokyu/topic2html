---
name: shadcn
description: topic2html のshadcn/ui部品を追加・検索・修正・デバッグ・スタイリングする。frontend/components.json、components/ui、Tailwind CSS、Radix component、registry、presetを扱うときに使用する。
---
