...
- 決定記録: 利用者が承認した変更内容、理由、影響範囲の履歴である。現在のTaskに適用する判断を確認するために必要である。
...
3. GitHub Issue本文、Issue #1、現在のTask Mapと接続台帳、Issueが指定する決定記録、直接の後続Issueを読む。
4. 現在のBranchとその最新Commit、依存Taskの完了証拠を確認する。
